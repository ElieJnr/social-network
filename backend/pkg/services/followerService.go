...
func (f *FollowerService) FollowUser(userId uuid.UUID, followedUser []models.User) error {
...
func (f *FollowerService) GetUserFollow(userId uuid.UUID, ok bool) ([]models.User, error) {
